...
import { ActivityIndicator, Alert, Button, ScrollView, StyleSheet, Text, TouchableOpacity } from "react-native";
        ...
        <ScrollView>
                ...
                {questions.map((q, index) => (
                    <View style={styles.container} key={q.id}>
                        ...
                        <RadioButton.Group
                            ...
                            {choices[q.id] && choices[q.id].map((choice) => (<>
                                <View key={choice.id} style={{ flexDirection: 'row', alignItems: 'center' }}>
                                    <RadioButton 
            ...
            {questions.length === 0 ? <>
                <View style={Style.noCommentContainer}>
                    <Text style={Style.noCommentText}>Không có câu hỏi nào được tạo</Text>
                </View>
            </> : <>
                <TouchableOpacity
                ...
                >
                    <View style={{
                        ...
                        <Text style={{color: "white", 
                            ...
                            marginTop: 14, 
                            fontSize: 15, 
                            fontWeight: "normal"}}>Hoàn thành</Text>
                    </View>
                </TouchableOpacity>
            </>}
